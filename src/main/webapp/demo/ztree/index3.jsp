...
<title>ztree</title>
<link rel="stylesheet" href="<%=request.getContextPath() %>/resources/zTree_v3-3.5.23/css/metroStyle/metroStyle.css">
<script type="text/javascript" src="<%=request.getContextPath() %>/resources/js/jquery-1.11.2.min.js"></script>
<script src="<%=request.getContextPath() %>/resources/zTree_v3-3.5.23/js/jquery.ztree.all.js"></script>
</head>
<body>
<script>
    var zTree;
