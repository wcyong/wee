...
<script src="<%=request.getContextPath() %>/resources/tab/Scripts/TreeTable/jquery.treeTable.js" type="text/javascript"></script>
<link href="<%=request.getContextPath() %>/resources/tab/Scripts/TreeTable/css/jquery.treeTable.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript">
	...
	function Delete() {
		...
		if (IsDelData(key)) {
			...
			var isExistparm = 'action=IsExist&tableName=Base_SysMenu&pkName=ParentId&pkVal='
					+ key;
			...
			var delparm = 'action=Virtualdelete&module=导航菜单&tableName=Base_SysMenu&pkName=Menu_Id&pkVal='
					+ key;
	...
	function allotButton() {
		...
		if (IsEditdata(key)) {
			...
			top.openDialog(url, 'AllotButton_Form', '导航菜单信息 - 分配按钮', 580, 370,
					50, 50);
	...
	<form id="form1" runat="server">
		...
		<div class="div-body">
			<table class="example" id="dnd-example">
				<thead>
					<tr>
						<td style="width: 230px; padding-left: 20px;">菜单名称</td>
						<td style="width: 30px; text-align: center;">图标</td>
						<td style="width: 60px; text-align: center;">类型</td>
						<td style="width: 60px; text-align: center;">连接目标</td>
